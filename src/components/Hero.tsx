...
const Hero: React.FC<IHeroApi> = ({ data }) => {
  const { title, subtitle, btntext, img, sociallinks, videos } = data;
  return (
    <>
        ...
        <div className="relavite opacity-100 z-20 grid items-center justify-items-center nike-container">
          <div className="grid items-center justify-items-center mt-28 md:mt-24">
            ...
            <div className="grid items-center gap-5 md:gap-3 absolute top-[33vh] lg:top-[27vh] left-[11%] xl:left-0 w-auto h-auto ">
              {videos?.map((val, i) => <Clips key={i} data={val} />)}
            </div>
            <div className="grid items-center absolute top-[33vh] lg:top-[27vh] right-[28px] gap-3">
